...
class Tour extends StatefulWidget {
  ...
  const Tour({Key key, this.user}) : super(key: key);
...
class _TourState extends State<Tour> {
                ...
                : Flexible(
                    child: Container(
                      ...
                      children: [
                        Center(
                            child: Text(
                          "Latest Tour and Travel Agencies",
                          style: TextStyle(
                                            ...
                                            Container(
                                              ...
                                              child: CachedNetworkImage(
                                                imageUrl: CONFIG.SERVER +
                                                    "/zuret/images/tour_and_travel_agencies/${_userlistgrams[index]['tourid']}.png",
                                                fit: BoxFit.cover,
  ...
  _showGram(int index) {
    print(_userlistgrams[index]['tourid']);
    print("HELLO");
    showDialog(
      context: context,
      builder: (context) => new AlertDialog(
        ...
        content: SingleChildScrollView(
          child: Container(
            ...
            child: Column(
              children: [
                Expanded(flex: 1, child: Text("Tour and travel agencies")),
                Expanded(
                    flex: 7,
                    child: SingleChildScrollView(
                        child: Text(_userlistgrams[index]['tourdesc']))),
                Expanded(
                    flex: 2,
                    child: Container(
                      width: screenWidth,
  ...
  void _loadGrams() {
    ...
    print(_pageno);
    http.post(Uri.parse(CONFIG.SERVER + "/zuret/php/tour_php/load_usergrams.php"),
        body: {
  ...
  void sendComment(String comment, int index, newSetState) {
    ...
    http.post(Uri.parse(CONFIG.SERVER + "/zuret/php/tour_php/insert_comment.php"),
        body: {
          "tour_id": _userlistgrams[index]['tourid'],
          "tour_owner": _userlistgrams[index]['tourid'],
          "tour_reply": widget.user.email,
          "tour_comment": comment,
        }).then((response) async {
          print(response.body);
  ...
  Future<List> loadComment(int index) async => http.post(
          Uri.parse(CONFIG.SERVER + "/zuret/php/tour_php/load_comments.php"),
          body: {
            "tourid": _userlistgrams[index]['tourid'],
          }).then((response) {
        List listComments;
