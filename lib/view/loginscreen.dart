...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _onLogin() async {
    ...
    http.post(Uri.parse("http://192.168.137.1:8081/touringholic/php/login_user.php"),
        body: {"email": _email, "password": _password}).then((response) {
      print(response.body);
      print("testttttttttttttt"+ response.body);
      if (response.body == "\nfailed"
) {
        ...
        Navigator.push(context,
            MaterialPageRoute(builder: (content) => Home(user: user)));
      }
    });
  }
